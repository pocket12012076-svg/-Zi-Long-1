export default function Footer({ lang }: { lang: string }) {
  const t = {
    ...
    en: {
      name: "Zi Long",
      desc: "Rational boundary builder. Dedicated to hearing submerged voices,\nreclaiming your choices amidst the chaos of humanity",
      nav: "Navigation",
      contact: "Contact",
      about: "About Zi Long",
      subscription: "Subscription",
      subDesc: "Subscribe to Weekly Newsletter\nWe explore cognitive sovereignty and boundary construction",
      subBtn: "Subscribe",
      placeholder: "Your email",
      rights: "© 2024 Zi Long. All Rights Reserved.",
      tagline: "Designed for Rational Boundary Builders."
    ...
    ja: {
      name: "子瓏 Zi Long",
      desc: "理性的な境界の構築者。人間性の喧騒の中で、\nかき消されたあなたの声を聞き取り、選択権を取り戻すお手伝いをします",
      nav: "ナビゲーション",
      contact: "お問い合わせ",
      about: "作家・子瓏について",
      subscription: "購読",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="lg:col-span-2">
            ...
            <p className="text-ink/70 font-normal max-w-sm leading-[1.8] mb-8 whitespace-pre-line">
              {t.desc}
            </p>
            <div className="flex flex-wrap gap-4">
              {[
                ...
                <a 
                  ...
                  className="px-6 py-3 border border-accent/30 rounded-full text-[18px] text-accent hover:bg-accent hover:text-bg transition-all duration-500 font-bold"
                >
                  {social.name}
                </a>
              ))}
          ...
          <div>
            ...
            <p className="text-[14px] text-ink/60 mb-4 leading-relaxed whitespace-pre-line">
              {t.subDesc}
            </p>
