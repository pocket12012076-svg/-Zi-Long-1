      ...
      <div className="flex-1 flex items-center justify-center px-6 py-24">
        <AnimatePresence mode="wait">
            ...
            <motion.div key={q-${currentIndex}} className="max-w-3xl mx-auto w-full" initial={{ opacity: 0, x: 60 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -60 }} transition={{ duration: 0.5, ease: "easeOut" }}>
              ...
              <motion.p className={text-2xl md:text-3xl font-serif leading-[1.8] text-ink ${currentQuestion.isClosing ? "text-accent italic" : ""}} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
