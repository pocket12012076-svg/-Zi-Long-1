...
export default function SubscriptionModal({ isOpen, onClose, lang = "zh" }: SubscriptionModalProps) {
  ...
  const t = {
    ...
    en: {
      title: "Subscribe to Zi Long",
      desc: "We explore cognitive sovereignty and boundary construction.",
          ...
          >
            ...
            {isSubmitted ? (
              ...
              <>
                ...
                <p className="text-white/60 mb-8 leading-relaxed whitespace-pre-line">
                  {t.desc}
                </p>
