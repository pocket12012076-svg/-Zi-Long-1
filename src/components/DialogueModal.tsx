...
const dialogues = [
  ...
  { 
    ...
    a: "當時我還看了另一本書，提到小孩出生後仍擁有與上帝對話的記憶，主要是再說-痛苦即是幸福。這讓我感覺人天生就是上帝的演員，各自拿著劇本發展人生。也就是說我們的靈魂本來是相親相愛的，只是喝了孟婆湯、演了戲才影響了對彼此的態度。",
    title: "人生劇本論"
  },
  { 
    id: "Q5", 
  ...
  { 
    ...
    a: "是的，我不想寫得太完美（簡單），我所謂的完美是，好像你只要求救了就會有人理你；你只要說「不」，對方就會停止；或是只要找到對的人就能獲救。因為在現實中，根本不會是那樣。\n其中一個令人失望的事，是社會對受傷的人有太多期待，總認為唯一出路是「活得勵志」，一旦你做不到，就被認為是你的問題。這讓我意識到其實很多人只是想看戲。這種期待會讓痛苦的人更困惑，因為總有人認為你活得不夠勵志，或認為你不可能這麼快走出來。\n但這其實都是一種「暗示」，我們都是在家庭和社會的暗示下長大，如果意識到自己的行為是受他人暗示的驅使，那麼脫掉這層外衣是必要的。只要察覺到了，你就有選擇權。",
    title: "社會的暗示"
  },
  { 
    id: "Q7", 
  ...
  { 
    ...
    a: "我遇過一個女孩，家裡重男輕女極深，母親因為懷了女孩導致孕期起就被婆婆虐待、被丈夫背叛，所以媽媽把一切仇恨都發洩在女孩的身上，後來弟弟誕生了，一切暴力似乎可以停止了。\n但弟弟因為感受的到媽媽的怨恨也變得非常憎恨姊姊，甚至會動手打她。\n她跟我說她從不怪她弟弟，弟弟只是聽媽媽的話，是個孝順的孩子。她說她的媽媽並不知道她有多討厭她；她的弟弟不知道他其實很愛她。她認為他們姊弟都是乖孩子，她意識到這個家不需要她，所以滿足媽媽的暗示離得他們遠遠的，但他們姊弟倆誰都沒有錯。\n以上正如我所說的「人是在暗示下長大」，你認為那位姊姊究竟做錯了甚麼？可以讓她弟弟恨到如此？而弟弟又為何可以膨脹到無法無天？",
    title: "暗示的實例"
  },
  { 
    id: "Q12", 
    ...
    a: "那位母親想過，但不想念。\n女兒好奇過她的母親想念她的甚麼？畢竟她們住在一塊時一點都不愉快過。\n後來她想明白了，因為媽媽只要心情不好就會拿她出氣，不擅於管理自己情緒的媽媽，只是因為宣洩出口消失而感到焦慮，所以才思念她的「女兒」。\n「思念」、「愛」等等的詞彙容易讓人產生誤會。\n當一個人說他愛小孩子，你就要思考他愛小孩子的甚麼？是單純外貌的可愛讓你捏了覺得舒服？還是心思單純、好操控的滿足感？如果你仔細觀察就會發現，並非每個人都認為年幼的孩子擁有身為人的人權。",
    title: "所謂的思念"
  },
  { 
    id: "Q13", 
    ...
    part: 2,
    q: "呈上題，這樣的察覺是否太無情？", 
    a: "是無情還是清醒？我曾在網路上聽過一句話「不重要的事情就像落在肩膀上的灰塵，拍掉就可以了」但問題是，如果你就是對方肩上的灰塵呢？\n那女孩同時也明白為什麼只要看見自己母親心情不好，她的天好像就要塌下來一樣的焦慮和恐慌，是因為她已經被定位成一個出氣筒，只是她不知道，也沒人告訴過她，最後還是她自己救了她自己，因為她察覺到了。",
    title: "察覺與無情"
  },
  { 
    id: "Q14", 
  ...
  { 
    ...
    a: "你還記得在最初期時，當你被人攻擊和污蔑、誤導的最一開始，在你真的相信對方口中的你之前，你心裡的聲音是否反抗過？\n有的話，請保留並且帶著它質疑一切，再透過察覺漸漸找回真正的自己，直至你死去。",
    title: "理性的美好"
  },
  { 
    id: "Q16", 
    ...
    a: "我想是的，這也是保護自己的一種方式，自我察覺如果可以快速到變成一種下意識的反射動作，你會發現你除了傷痛、憤怒以外，還有很多情緒都被這些激烈的情緒給淹沒了。\n被淹沒的情緒久了也會有壓力，甚至會潛移默化的影響你的身體。\n自我察覺也包含那些被忽略的聲音，只要聽到你就會發現你的選擇其實很多。",
    title: "情感的界限"
  },
  { 
    id: "Q17", 
    ...
    a: "因為不是每個人的自覺能力都很強，每個人都有盲點，但透過自覺你的盲點會越來越小。\n回歸到你問的，舉例來說：「你會一直跟別人強調你有一對雙眼嗎？」\n當你出生時就和其他人一樣擁有一對雙眼，你會一直向人說：「我有一對眼睛喔」。在我的觀察裡人不會過度強調事實，那對方又為什麼要這樣做？我認為那才是該去思考的部分。",
    title: "行為的目的"
  },
  { 
    id: "Q18", 
    ...
    a: "休息吧。忙著生存的你或許已耗掉非常多的精力。\n我在學鋼琴的過程中學到一件事：「休息非常的重要」，當我有幾個音一直彈不好時，我會做點其他的事情去轉移注意力來休息，而每當我繼續回來練習時，我發現我總是可以有明顯的進步。\n許多人認為休息和快樂是不長進的表現，但我們身心都需要一個平衡，給自己一點喘息的空間、跟自己相處，等精神和體力恢復，你才能夠繼續前進。",
    title: "休息的重要"
  },
  { 
    id: "Q19", 
    ...
    a: "我指的生存，從來不是指出社會賺錢，而是從出生那一刻就開始的「心理防禦戰」。\n不是每個人都能在安全中長大。小孩子有時候活得比大人辛苦得多，因為他們沒有選擇權，也沒有能力反抗，甚至是很迷惘的，所以只能透過「改變自己」來在這個家活下去。",
    title: "所謂的生存"
  },
  { 
    id: "Q20", 
    ...
    a: "首先我要說關於「愛」沒有一定的答案，只是在我的觀察中有些人在原生家庭中學到的愛是錯的。有人可能認為愛是控制、是改變、是犧牲，或是給予金錢\n靈魂本質的愛是純粹的，但進入人世間的教育與暗示後，愛往往會被扭曲成其他代名詞。\n再來，網路上曾有人說：「你的原生家庭會影響你選擇的另一半」這句話沒有錯，但我關心的是：「那接下來呢？」預判自己的選擇可以說是命、是上帝給的劇本內容，但既然知道自己容易這樣，那就需要察覺了。\n透過各種方式了解自己很好，但要繼續思考。\n最後，當你的原生家庭是地獄級別的，如果還有人用情緒勒索的方式要你回家，把戲演到「快樂結局」時，例如「父母沒把你丟在路邊」，請遠離這樣要求你的人，他們的道德觀和施暴者沒兩樣。\n我們感謝父母給我們生命這個事實，但也不要為了自己想擁有平安長大的權利而感到愧疚。接下來，請按照那些情勒者所說的邏輯，把自己當作最尊貴的人供起來好好養著——感謝你自己還活著",
    title: "原生家庭的愛"
  },
  { 
    id: "Q21", 
    ...
    a: "有時候你的善良不被信任，也許是因為對方都是以惡待人。\n就跟鏡子一樣，對方把自己的行為套用在你身上，然後以此去預判和批評你，但對方不了解真正的你。此時你不需要多想為什麼總是解釋不清或是怎麼做都達不到對方的要求，你只需要意識到：「他正在防備他自己內心那個惡的投影。」轉身離開吧，因為你不可能期望鏡子做出和你不同的動作。\n這其實就回歸到我在「關於我成為作家的10個QA」的Q7所說的「當有人比你更了解你時，處境會變得很危險」，只是現在角色對調了過來。",
    title: "善良與鏡子"
  },
  { 
    id: "Q22", 
  ...
  { 
    ...
    a: "這算一種要求，對情感不合理的要求。\n情感是本能所產生的，一種自發性的產物，身為動物的我們無法為此做出「選擇」，就像你無法選擇你要愛誰或是厭惡誰，「選擇」是理性在做的事情。\n但傷痛不是只是傷痛，它是有意義的，傷痛是你可以察覺自己過去遭受到甚麼影響的機會，那是你了解自己的契機。\n就如你的身體在向你求救，像個孩子不會說話只會讓你感到不舒服，所以你的理性就必須要去意識到這個不舒服，讓這個不快被看見，去承認它，你才能接住自己。",
    title: "原諒的暗示"
  },
  { 
    id: "Q24", 
    ...
    a: "意外收穫了對「人性的清醒」。\n當我越看清楚事實，越理解自己，我就能活得越輕鬆。有時候遭受惡意並非是受害者的問題，是對方的行為偏差導致。\n也就是說，今天換作是別人其實事件也是會發生，所以在我的小說裡，我才會認為是天使來人間代替人類受罪的。",
    title: "意外的收穫"
  },
  { 
    id: "Q25", 
    ...
    a: "當我有些情緒產生時，不論是正面或負面，我都會停下來思考剛剛發生了甚麼事情。\n假設是雨天讓我回家時把玄關弄得濕答答的而感到煩躁，或是過去那些陰影偶爾襲來的恐慌感出現導致，我會意識到那些「原因」是我無法改變的事實時，我就不會再被過去控制。\n其實很簡單就是先去認清甚麼是事實，理解情緒。人對未知是會有恐懼的，所以當你不了解你的情緒時，你的無知會放大你的感受。\n再來是多去聽聽自己說了甚麼、做了甚麼，用自己的行為去觀察自己想要甚麼，有時候我們會在某些情況下做出自身都無法預料的事情，導致氣氛尷尬或傷到別人，你除了觀察自己以外也要多看看別人的反應，不斷去反思原因。\n我覺得有意識的覺醒是對自己負責任的方式。\n但必須要說，養成任何一個習慣之前，一定會花不少時間和挫折，一但習慣養成，那就是別人無法拿走的資產。",
    title: "察覺的實踐"
  },
  { 
    id: "Q26", 
    ...
    a: "人是動物，受困於本能的匱乏，為了生存往往會做出傷人的舉動。\n我認為，社會之所以如此用力地歌頌「犧牲」與「愛」，正是因為缺乏這些特質，才需要透過不斷的強調來掩飾。但這種歌頌偉大，反而成了人為本惡的鐵證，就如前面Q7所說「人不會過度強調事實」，也因此我在Q4強調「要讓感性去承認黑暗的存在，同時讓理性去守住那一點點後天選擇的良善。」。\n又或許，人是盲目的，只是一味跟從，久了就會變成一種要求；而那要求曾剝奪了許多人的聲音，只為了滿足大眾想看的一場秀。",
    title: "犧牲與愛"
  },
  { 
    id: "Q27", 
    ...
    a: "面對選擇的時候我會選擇風險對我來說是能接受的。\n再加上我執行力很強，所以很多時候我自己也不會知道我下一個身分會是甚麼，就像我從沒想過會成為作家一樣。我想如果你知道自己在做甚麼，也懂得面對已發生的事情，就很難會有後悔和遺憾。",
    title: "不後悔的實驗"
  },
  { 
    id: "Q28", 
    ...
    a: "我在小說的後記裡提過，我曾聽過一句話：「你的一切行為都有影響力」，所以我認為身而為人，在這個社會上生活，不論你的社會地位還是性別，只要你是個成年人，所說的話所做的事情，都要考慮到「社會責任」的問題。\n我甚至認為很多時候只要管好自己就是對這社會最大的貢獻。",
    title: "定義權與責任"
  }
];
...
export default function DialogueModal({ isOpen, onClose, lang }: DialogueModalProps) {
  ...
  const translations = {
    ...
    ja: {
      ...
      Q4: { q: "あなたの作品には非常に特殊な「人生脚本論」がありますが、このインスピレーションはどこから来たのでしょうか？", a: "当時、別の本も読んでいて、そこには子供は生まれた後も神様と対話した記憶を持っていると書かれてい、主に「痛みは幸福である」と述べられていました。\n\nこれにより、人間は生まれながらにして神様の役者であり、各自が脚本を持って人生を展開しているのだと感じるようになりました。つまり、私たちの魂はもともと愛し合っていたのですが、孟婆のスープを飲み、劇を演じることで、お互いに対する態度に影響が出ただけなのです。", title: "人生脚本論" },
      ...
      Q12: { q: "前項の質問に関連しますが、母親は娘を恋しく思うことはないのでしょうか？あなたが考える「思念（恋しさ）」とは、どのようなものですか？", a: "その母親は娘のことを考えはしましたが、決して「思念」してはいませんでした。\n\n娘はかつて、母が自分の何を恋しがっているのか不思議に思っていました。一緒に暮らしていた頃、一度も楽しい時間などなかったからです。\n\n後に彼女は気づきました。母は気分が悪いといつも自分を八つ当たり（感情の捌け口）にしていました。感情をコントロールできない母にとって、その「出口」が消えたことによる焦燥感こそが、彼女が抱く「娘への思念」の正体だったのです。\n\n「思念」や「愛」といった言葉は、しばしば誤解を招きます。\n\n誰かが「子供が好きだ」と言うとき、その人は子供の何を愛しているのかを考えなければなりません。単に外見が可愛くて触れると心地よいからか、それとも純粋で思い通りに操れる満足感からか。注意深く観察すれば、幼い子供にも一人の人間としての「人権」があると考えている大人が、必ずしも全員ではないことに気づくはずです。", title: "思念の虚像" },
      Q13: { q: "今の話を聞くと、そのような察覚（気づき）はあまりにも無情ではないでしょうか？", a: "それは無情でしょうか、それとも「清醒（しらふ）」でしょうか。ネットでこんな言葉を見たことがあります。「重要でないことは、肩に落ちた埃のように払えばいい」。しかし問題は、もしあなた自身が相手の肩に乗った「埃」だとしたらどうでしょう？\n\nその少女は、なぜ母親の機嫌が悪いと、まるで空が崩れ落ちるような不安とパニックに陥るのかを理解しました。自分が知らぬ間に「八つ当たりの道具」として定義されていたからです。誰も教えてはくれませんでしたが、彼女は自ら気づくことで、最終的に自分自身を救い出したのです。", title: "清醒と無情" },
      Q14: { q: "前問に続き、暗示に気づくこと以外に、読者が自分を守るための他の方法はありますか？", a: "感性を無限に広げて、この世界が持つ暗い面を体験し、それを受け入れ認めるように努めてください。そして、理性には世界の善良な面を見る権利を保持させてください。\n\n私は痛みの存在を否定しませんし、悪の行為を正当化もしません。暴力は一定であり必然的な存在ですが、私は自分の理性を守り、理性が私を導いて生きていけるようにしなければなりません。\n\nこれは矛盾していて困難かもしれませんが、実はこれによって、Q1のお姉さんが理性的に立ち去り生きることを選んだように、自分の次のステップを選択するための多くの権利を自分に与えることができるのです。", title: "保護の方法" },
      Q15: { q: "前問に続き、傷ついた後に「理性的に美しさを見る」には、どうすればいいのでしょうか？", a: "一番最初の時期、あなたが攻撃され、汚され、誤解されたその最初、相手の言う通りの自分を本当に信じてしまう前に、あなたの心の中の声は反抗しませんでしたか？もしそうなら、どうかそれを持ち続け、すべてを疑ってください。そして察覚を通じて、死ぬまで本当の自分を少しずつ取り戻していってください。", title: "理性の美しさ" },
      Q16: { q: "前問に続き、あなたはすべての感情を非常に明確に境界線で区切っているようで、理性さえも意識的な感情として擬人化していますが、これはあなたの物事の見方の特徴ですか？", a: "そう思います。これも自分を守るための一つの方法です。自己察覚が下意識の反射動作になるほど速くなれば、痛みや怒り以外にも、多くの感情がこれらの激しい感情に飲み込まれていることに気づくでしょう。飲み込まれた感情は時間が経つとストレスになり、さらには潜在的に体に影響を与えます。自己察覚には、無視されてきた声も含まれます。その声を聴きさえすれば、自分の選択肢が実はたくさんあることに気づくはずです。", title: "感情の境界線" },
      Q17: { q: "あなたは人間は動物であり、行動の背後にある目的は相手が言う言葉よりも重要だと主張していますが、具体的にはどういう意味でしょうか？", a: "すべての人の自覚能力が強いわけではなく、誰にでも盲点がありますが、自覚を通じて盲点はどんどん小さくなっていきます。あなたの質問に戻ると、例えば：『あなたは一対の目を持っていることを他人に強調し続けますか？』生まれた時から他の人と同じように一対の目を持っているなら、人に『私には目がありますよ』と言い続けることはないでしょう。私の観察では、人は事実を過度に強調することはありません。では、なぜ相手はそうするのでしょうか？私はそれこそが考えるべき部分だと思います。", title: "行動の目的" },
      Q18: { q: "「私が作家になるまでの10のQA」のQ8にある「私はダメだ」という理念を引き継いで、多くの人が「その次は？」と尋ねていますが？", a: "休みましょう。生きることに追われているあなたは、おそらく非常に多くのエネルギーを消耗しています。私はピアノを習う過程で一つのことを学びました：『休息は非常に重要である』ということです。何度弾いてもうまくいかない音があるとき、私は他のことをして注意をそらし、休みます。そして再び練習に戻るたびに、常に明らかな進歩があることに気づきます。\n\n多くの人は、休息や楽しみは向上心のない表れだと考えますが、私たちの心身にはバランスが必要です。自分に少しの息抜きの空間を与え、自分自身と向き合い、精神と体力が回復するのを待って初めて、前進し続けることができるのです。", title: "休息的重要" },
      Q19: { q: "あなたがよく口にする「生存」という言葉は、とても過酷に聞こえます。あなたにとっての「生存」の定義とは何ですか？", a: "私が言う生存とは、社会に出てお金を稼ぐことではなく、生まれた瞬間から始まる「心理的防衛戦」のことです。\n\n誰もが安全な環境で育てるわけではありません。子供は時に大人よりずっと苦しく生きています。なぜなら、彼らには選択権もなく、反抗する能力もなく、ただ戸惑うことしかできないからです。ゆえに、その家で生き延びるために「自分自身を創り変える」しかないのです。", title: "生存の構造" },
      Q20: { q: "「私が作家になるまでの10のQA」のQ4で「魂はもともと愛し合っている」とおっしゃっていましたが、現実には多くの傷が最も身近な原家族から生じます。「愛の本質」と「誤った教育」が衝突したとき、私たちはどう身を処すべきでしょうか？", a: "まず、『愛』について決まった答えはないと言っておきます。ただ私の観察では、原家族の中で学んだ愛が間違っている人がいます。愛とは支配すること、変えること、犠牲にすること、あるいは金銭を与えることだと考えている人がいるかもしれません。だからこそ、多くのパラサイト・シングルは親から自立を求められた時に不安を感じたり、親が他の人に金を渡すのを見て怒りを感じたりするのです。\n\nまた、ネット上で『あなたの原家族は、あなたが選ぶパートナーに影響を与える』という言葉がありますが、これは間違いではありません。しかし私が関心があるのは、『その次は？』ということです。自分の選択を予測することは運命であり、神が与えた台本の内容だと言えますが、自分がそうなりやすいと分かっているなら、察覚が必要です。様々な方法で自分を知ることは良いことですが、考え続ける必要があります。\n最後に、あなたの原家族が地獄レベルである場合、もし誰かが感情的なゆすりを使ってあなたを家に帰らせ、『ハッピーエンド』の芝居を演じさせようとするなら（例えば『親はあなたを道端に捨てなかった』など）、そんな要求をする人からは離れてください。彼らの道徳観は加害者と何ら変わりません。私たちは親が命をくれたという事実に感謝しますが、自分が平安に育つ権利を持ちたいと願うことに罪悪感を感じる必要もありません。そして、感情的なゆすりをする人が言う論理に従って、自分自身を大切に祀り上げ、生きていることに感謝してください。", title: "原生家庭の愛" },
      Q21: { q: "成長の過程で、私たちはよく親切であるように教えられます。しかし、なぜ時として私たちが差し出した善意が、相手から悪意や不信感で返されることがあるのでしょうか？これは親切には条件があるということですか？", a: "時としてあなたの親切が信頼されないのは、おそらく相手が誰に対しても悪意を持って接しているからかもしれません。鏡と同じように、相手は自分の行動をあなたに当てはめ、それによってあなたを予測し批判しますが、相手は本当のあなたを理解していません。この時、なぜいつもはっきりと説明できないのか、あるいはどうやっても相手の要求に届かないのかを考えすぎる必要はありません。ただ、『彼は自分自身の心の内の悪の投影を警戒しているのだ』と気づくだけでいいのです。背を向けて立ち去りましょう。鏡があなたと異なる動きをすることを期待することはできないからです。\n\nこれは実は、『私が作家になるまでの10のQA』のQ7で言った『誰かがあなた以上にあなたのことを知っているとき、状況は非常に危険になる』ということに戻りますが、今は役割が入れ替わっただけです。", title: "親切と鏡" },
      Q22: { q: "「私が作家になるまでの10のQA」のQ7で、理解されることは危険だと言及されていました。では、あなたは人から見透かされるのを恐れて、社交の場で本当の自分を「隠す」ことがありますか？", a: "自分自身に焦点を当てる必要があると思います。私が言っているのは、自分を理解することを優先し、自分が自分を最もよく知る人間になることで、他人の暗示を心配する必要がなくなるということです。\n\n悪意は存在し、どこへ行っても遭遇します。唯一コントロールできるのは自分自身だけです。だから私は「見透かされる」ことを恐れません。自分がなぜそのような反応をするのかを自分自身が知っていれば、それで十分なのです。\n\n「シンプルに生きる」ということも私が言いたいことです。自分を複雑にしすぎないでください。過去の影が再来したとき、心がパニックを感じ、反応が激しくなるのは理解できます。それは過去の自分を守れなかった自分を守りたいからです。しかし、理性の権利を保持し、理性に現在の時空でもっと観察させ、自己察覚を通じてゆっくりと純粋な自分を生きてください。", title: "社交と真実" },
      Q23: { q: "前問に続き、「なぜ忘れることを選べないのか？」「許せば済むことじゃないか？」というのも一種の暗示ですか？", a: "それは一種の要求であり、感情に対する不合理な要求です。感情は本能から生じる自発的な産物であり、動物である私たちはそれに対して「選択」をすることはできません。誰を愛し、誰を嫌うかを選べないのと同じです。「選択」は理性がすることです。\n\nしかし、痛みはただの痛みではなく、意味があります。痛みは、過去に自分がどのような影響を受けたかに気づくための機会であり、自分を知るためのきっかけです。あなたの体はあなたに助けを求めています。言葉を話せず、ただ不快感を与えるだけの子供のようなものです。ですから、あなたの理性がその不快感に気づき、その不快さを見えるようにし、それを認めてあげることで、初めて自分自身をキャッチできるのです。", title: "原諒の暗示" },
      Q24: { q: "あなたが強調する自己察覚について、どのように行っているか例を挙げてもらえますか？", a: "ポジティブであれネガティブであれ、何らかの感情が生じたとき、私は立ち止まって今何が起こったのかを考えます。例えば、雨の日に帰宅して玄関を濡らしてしまったことにイライラしたり、過去の影が時折襲ってくるパニックが原因だったりする場合、それらの「原因」が自分では変えられない事実であると気づけば、もはや過去に支配されることはありません。\n\n実はとてもシンプルです。まず何が事実かを見極め、感情を理解することです。人間は未知のものに対して恐怖を抱きます。ですから、自分の感情を理解していないとき、無知があなたの感情を増幅させてしまうのです。\n\nさらに、自分が何を言い、何をしたかをもっと聴き、自分の行動から自分が何を望んでいるかを観察してください。時として、私たちは特定の状況で自分でも予想外のことをしてしまい、気まずい雰囲気になったり他人を傷つけたりすることがあります。自分を観察するだけでなく、他人の反応もよく見て、その原因を絶えず反省すべきです。意識的な目覚めこそが、自分に対する責任の取り方だと思います。", title: "察覚の実践" },
      Q25: { q: "読者は、「私が作家になるまでの10のQA」のQ3で小説は意外な収穫だったと言及されていましたが、他に意外な収穫はありましたか？と知りたがっています。", a: "「人間性に対する覚醒」を予期せず収穫しました。事実をはっきりと見れば見るほど、自分自身を理解すればするほど、より楽に生きることができます。時として悪意を受けるのは被害者の問題ではなく、相手の行動の偏りによるものです。つまり、今日それが別の人であっても、事件は起こっていたということです。だから私の小説では、天使が人類の代わりに苦しむために人間界に来たのだと考えているのです。", title: "意外の収穫" },
      Q26: { q: "人間性に対するあなたの観察は、しばしば「動物的」な冷静さを帯びています。社会一般で広く称賛されている「自己犠牲」や「無私の愛」について、異なる見解をお持ちですか？", a: "人間は動物であり、生き残り、自己を満たすためなら何でもします。\n\n社会がこれほどまでに「犠牲」や「愛」を声高に称賛するのは、まさにそれらの資質が欠けているからこそ、絶え間ない強調を通じて覆い隠す必要があるからだと私は考えています。しかし、このような偉大さの称賛は、かえって人間が本来悪であることの鉄の証拠となってしまいました。前述のQ7で言ったように「人は事実を過度に強調しない」からです。だからこそQ4で「感性には闇の存在を認めさせ、同時に理性には後天的に選択したわずかな善良さを守らせるべきだ」と強調したのです。\nあるいは、人間は盲目であり、ただ盲目的に従っているだけなのかもしれません。時間が経てばそれは一種の要求となり、その要求はかつて多くの人々の声を奪ってきました。ただ大衆が見たいショーを満足させるためだけに。", title: "犠牲と愛" },
      Q27: { q: "動物性の理論に従えば、人間特有の「後悔」や「遺憾」について、あなたはどうお考えですか？", a: "選択を迫られたとき、私は常に「自分が許容できるリスク」を選びます。\n\nさらに、私は実行力が非常に強いため、自分が次にどのような「身分」になるか、自分でも予測がつかないことが多いのです。作家になるとは夢にも思わなかったように。自分の行動を自覚し、起きた出来事に向き合う術を知っていれば、後悔や遺憾が入り込む余地はほとんどないと考えています。", title: "選択の設計" },
      Q28: { q: "あなたはよく、自分を理解することを優先し、定義権を取り戻すべきだと言及されています。傷ついた後の自己防衛の過程において、これらはすべて必要不可欠なものですか？それとも自己中心的すぎますか？", a: "小説の後書きで、「あなたのすべての行動には影響力がある」という言葉を聞いたことがあると言及しました。ですから、人間としてこの社会で生きる以上、社会的な地位や性別に関わらず、成人であるならば、発する言葉や行う行動はすべて「社会的責任」の問題を考慮すべきだと考えています。私は、多くの場合、自分自身を律することこそがこの社会に対する最大の貢献であるとさえ思っています。", title: "定義権と責任" }
    }
  };
            ...
            <div className="relative z-10 flex flex-1 overflow-hidden">
              ...
              >
                ...
                <div className="max-w-2xl mb-24">
                  ...
                  <p className="text-white/60 text-[18px] leading-[1.8] whitespace-pre-line">
                    {t.introDesc}
                  </p>
                </div>
                      ...
                      <div key={d.id} id={d.id} data-qa-id={d.id} className="scroll-mt-32">
                        ...
                        <div className="max-w-3xl">
                          ...
                          <div className="pl-12 relative">
                            ...
                            <div className="text-white text-[18px] md:text-[20px] leading-[1.8] font-serif">
