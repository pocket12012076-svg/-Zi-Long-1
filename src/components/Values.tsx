...
export default function Values({ lang }: { lang: string }) {
  ...
  const t = {
    zh: {
      ...
      noteTitle: "【子瓏的深度察覺筆記：28 則生存對話】",
      noteDesc: <>在別人的劇本裡，你只是個被命名的角色。<br/><br/>這 28 則對話分為兩部。第一部【關於我如何成為作家的 10 個 QA】記錄了我創作和覺察的真實過程；第二部為進階版【子瓏的深度察覺筆記】。<br/><br/>為了幫你找回失落的原初聲音，你可以由【子瓏的深度察覺筆記】 Q1 循序進入，剝離那些不屬於你的裝扮；或者利用以下「價值地圖」，在你需要的生存座標上，重新定義自己。</>,
      values: [
        {
          id: "01",
          title: "認知脫鉤術",
