      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-20 items-center">
              <div className="flex-1 order-2 lg:order-1">
                ...
                <div className="space-y-6 text-ink/70 leading-[1.8] text-lg text-justify">
                  {t.aboutText.map((p, i) => (
                    <p key={i}>{p}</p>
                  ))}
                </div>
                ...
                >
                  <p className="text-accent font-serif italic text-xl text-center leading-relaxed">
                    {t.quote}
                  </p>
                </motion.div>
              </div>
        ...
        <section className="py-32 px-6 bg-accent text-bg relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-[20px] opacity-80 mb-12 max-w-2xl mx-auto leading-relaxed whitespace-pre-line">
              {t.ctaDesc}
            </p>
            <button 
